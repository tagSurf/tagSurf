...
var add_icon, add_state = "blue", add_icons = {
  fill: 'tagsurf-assets.s3.amazonaws.com/img/add_icon_fill.png',
  blue: 'tagsurf-assets.s3.amazonaws.com/img/add_icon_blue.png'
};
...
var populateNavbar = function () {
  ...
  var navbar_content = [
    "<div id='favorites-btn'>",
      "<a onclick='starCallback();'><img id='favorites-icon' src='tagsurf-assets.s3.amazonaws.com/img/favorites_icon_blue.png'></a>",
    "</div>",
    "<div id='add-btn'>",
      "<a onclick='slideAddBar();'><img id='add-icon' src='tagsurf-assets.s3.amazonaws.com/img/add_icon_blue.png'></a>",
    "</div>",
      ...
      "<label id='slider-label' for='slider-box' ontouchmove='return false;' onclick='slideNavMenu();'>",
        "<span id='main-logo'>",
          gallery ? (gallery == "tag"
            ...
            : ("<img class='gallery-icon' src='tagsurf-assets.s3.amazonaws.com/img/" + gallery + "_icon_gray.png'><span id='gallery-name' class='pointer'>" + gallery.toUpperCase() + "</span>"))
          : "<img id='tagsurf-logo' src='tagsurf-assets.s3.amazonaws.com/img/logo_big.png'></img>",
        "</span><span id='history-logo'>HISTORY</span>",
        "<img id='slider-icon' " + (gallery ? "" : "class='vtop' ") + "src='tagsurf-assets.s3.amazonaws.com/img/down_arrow_nav.png'></img>",
      "</label>",
    "</div>",
  ], 
  full_slider_content = [
    ...
    "<div id='slide-down-menu' class='pointer'>",
      "<ul>",
      	"<li><a href='/feed'><div>",
      	  "<img class='menu-icon' src='tagsurf-assets.s3.amazonaws.com/img/trending_icon_gray.png'></img>&nbsp;&nbsp;&nbsp;TRENDING",
      	"</div></a></li>",
      	"<li><a href='/favorites'><div>",
      	  "<img class='menu-icon' src='tagsurf-assets.s3.amazonaws.com/img/favorites_icon_gray.png'></img>&nbsp;&nbsp;&nbsp;FAVORITES",
        "</div></a></li>",
        "<li><a href='/history'><div>",
      	  "<img class='menu-icon' src='tagsurf-assets.s3.amazonaws.com/img/history_icon_gray.png'></img>&nbsp;&nbsp;&nbsp;HISTORY",
        "</div></a></li>",
        "<li><a id='options-btn'><div>",
          "<img class='menu-icon' src='tagsurf-assets.s3.amazonaws.com/img/options_icon.png'></img>&nbsp;&nbsp;&nbsp;OPTIONS",
        "</div></a></li>",
        "<li><a id='logout'><div>",
          "<img class='menu-icon' src='tagsurf-assets.s3.amazonaws.com/img/logout_icon_gray.png'></img>&nbsp;&nbsp;&nbsp;LOGOUT",
        "</div></a></li>",
      "</ul>",
    "</div>",
  ],
  reduced_slider_content = [
    ...
    "<div id='slide-down-menu' class='pointer'>",
      "<ul>",
        ...
        "</div></a></li>",
        "<li><a id='login'><div>",
          "<img class='menu-icon inverted' src='tagsurf-assets.s3.amazonaws.com/img/logout_icon_gray.png'></img>&nbsp;&nbsp;&nbsp;LOGIN",
        "</div></a></li>",
      "</ul>",
    "</div>",
  ],
  ...
  tag_adder.innerHTML = "<input value='#newtag' spellcheck='false' autocomplete='off' autocapitalize='off' autocorrect='off'><img src='tagsurf-assets.s3.amazonaws.com/img/add_tag_button.png'><div id='add-tag-autocomplete' class='autocomplete hider'></div>";
...
var setFavIcon = function(filled) {
  document.getElementById("favorites-icon").src =
    "tagsurf-assets.s3.amazonaws.com/img/favorites_icon_" + (filled ? "fill" : "blue") + ".png";
};
