...
var populateNavbar = function () {
  ...
  var navbar_content = [
    "<div class='favorites-btn'>",
      "<a href='favorites.html'><img src='img/favorites_icon_" + (gallery == "favorites" ? "fill" : "blue") + ".png'></a>",
    "</div>",
    "<div class='history-btn'>",
      "<a href='history.html'><img src='img/history_icon_" + (gallery == "history" ? "fill" : "blue") + ".png'></a>",
    "</div>",
  ...
  var menu_slider_content = [
    ...
    "<div id='slide_down_menu' class='pointer'>",
      "<ul>",
      	"<li><div>",
      	  "<a href='trending.html'><img class='menu_icon' src='img/trending_icon_gray.png'></img>&nbsp;&nbsp;&nbsp;TRENDING</a>",
      	"</div></li>",
      	"<li><div>",
      	  "<a href='favorites.html'><img class='menu_icon' src='img/favorites_icon_gray.png'></img>&nbsp;&nbsp;&nbsp;FAVORITES</a>",
        "</div></li>",
        "<li><div>",
      	  "<a href='submissions.html'><img class='menu_icon' src='img/submissions_icon_gray.png'></img>&nbsp;&nbsp;&nbsp;SUBMISSIONS</a>",
        "</div></li>",
        "<li><div>",
          "<a href='options.html'><img class='menu_icon' src='img/options_icon.png'></img>&nbsp;&nbsp;&nbsp;OPTIONS</a>",
        "</div></li>",
        "<li><div>",
