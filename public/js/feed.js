...
onload = function ()
{
	...
	var setReminderTimeout = function ()
	{
		...
		close.src = "tagsurf-assets.s3.amazonaws.com/img/Close.png";
		...
		if(isDesktop()) {
			...
			closeInstructions.src="tagsurf-assets.s3.amazonaws.com/img/clearscreen.png";
			reminderContainer.appendChild(closeInstructions);
			rightImage.src = "tagsurf-assets.s3.amazonaws.com/img/reminder_right_desktop.png";
			leftImage.src = "tagsurf-assets.s3.amazonaws.com/img/reminder_left_desktop.png";
			addCss({
			...
			leftImage.src = "tagsurf-assets.s3.amazonaws.com/img/reminder_left_mobile.png";	
			rightImage.src = "tagsurf-assets.s3.amazonaws.com/img/reminder_right_mobile.png";
		}
	...
	var refreshCards = function(failMsgNode, zIndex) {
		...
		if (failMsgNode && data.length == 0) {
			...
			trendingBtn.innerHTML = "<img src='tagsurf-assets.s3.amazonaws.com/img/trending_icon_blue.png'>Return to <span class='blue'>#trending</span>";	
			...
			gesture.listen("down", trendingBtn, function() {
				...
				trendingBtn.firstChild.src = "tagsurf-assets.s3.amazonaws.com/img/trending_icon_gray.png";
			});
			gesture.listen("up", trendingBtn, function() {
				trendingBtn.classList.remove("active-trending-returnbtn");
				trendingBtn.firstChild.src = "tagsurf-assets.s3.amazonaws.com/img/trending_icon_blue.png";
				if(isAuthorized())
...
//		addHistoryItem(activeCard);
	...
	var dataThrobTest = function ()
	{
		...
		if (data.length <= cardIndex) {
			...
			img.src = "tagsurf-assets.s3.amazonaws.com/img/throbber.gif";
	...
	var buildContentCard = function(c, zIndex) {
		var imageContainer, iconLine, textContainer, picTags, fullscreenButton,
			...
			cardTemplate = "<div class='card-wrapper'><div class='card-container' style='z-index:" + zIndex + ";'><div class='image-container expand-animation'><img" + (firstCardLoaded ? (" src='" + image.get(c, window.innerWidth - 40).url + "'") : "") + "></div><div class='icon-line'><img class='source-icon' src='tagsurf-assets.s3.amazonaws.com/img/" + (c.source || ((c.tags[0] == null || c.tags[0] == "imgurhot") ? "imgur" : "reddit")) + "_icon.png'><span class='tag-callout pointer'><img src='tagsurf-assets.s3.amazonaws.com/img/trending_icon_blue.png'>&nbsp;#" + c.tags[0] + "</span></div><div class='text-container'><p>" + c.caption + "</p></div><div id='pictags" + c.id + "' class='pictags'></div><div class='expand-button'><img src='tagsurf-assets.s3.amazonaws.com/img/down_arrow.png'></div><div id='thumb-vote-container'><img class='thumb-up' src='tagsurf-assets.s3.amazonaws.com/img/thumbsup.png'><img class='thumb-down' src='tagsurf-assets.s3.amazonaws.com/img/thumbsdown.png'></div><div class='super-label'>SUPER VOTE</div></div></div>";
		...
		if (current_tag == "trending") {
			gesture.listen("down", iconLine.children[1], function() {
				...
				iconLine.children[1].firstChild.src = "tagsurf-assets.s3.amazonaws.com/img/trending_icon_gray.png";
			});
			gesture.listen("up", iconLine.children[1], function() {
				iconLine.children[1].classList.remove("active-tag-callout");
				iconLine.children[1].firstChild.src = "tagsurf-assets.s3.amazonaws.com/img/trending_icon_blue.png";
	...
	var buildLoginCard = function(c, zIndex) {
		var formatter = document.createElement('div'),
			top = "<div class='card-wrapper'><div class='card-container login-card' style='z-index:" + zIndex + ";'><img src='tagsurf-assets.s3.amazonaws.com/img/logo_w_border.png'><div class='big bold'>Hate repeats? Sign up!</div>",
