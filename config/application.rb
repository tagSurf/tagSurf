...
module Tagsurf
  ...
  config.assets.precompile += %w( gallery_page.js sessions.js signup.js welcome.js push.js contacts.js gallery_page.css sessions.css welcome.css contacts.css )
